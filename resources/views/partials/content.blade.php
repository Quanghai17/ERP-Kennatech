<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i>Thống kê báo cáo</h1>
        </div>
    ...
    <div class="row">
        <div class="col-md-6 col-lg-3">
            <div class="widget-small primary coloured-icon"><i class="icon fa fa-credit-card-alt fa-3x"></i>
                <div class="info">
                    <h5>Số dư: {{number_format($total->total_amount)}} VNĐ</h5>
                    <a href="{{ route('transaction.create') }}" class="btn btn-primary">Nạp tiền</a>
                    <a href="{{ route('transaction.create') }}" class="btn btn-success">Rút tiền</a>
                    <a href="{{ route('transaction.index') }}" class="btn btn-warning">Lịch sử</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="tile">
                <h3 class="tile-title">Thống kê nhập xuất hàng</h3>
        ...
        <div class="col-md-6">
            <div class="tile">
                <h3 class="tile-title">Thống kê khách hàng</h3>
                <div class="embed-responsive embed-responsive-16by9">
