...
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-edit"></i>Thêm sản phẩm cho mượn</h1>
                <p>Mẫu thêm</p>
            </div>
            ...
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('loanproduct.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label class="control-label">Tên người mượn: </label>
                                    <input name="borrower" class="form-control @error('borrower') is-invalid @enderror"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="pay_day" class="form-control @error('pay_day') is-invalid @enderror"
                                        type="date" required>
                                    @error('pay_day')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                    ...
                                    <div class="group row">
                                        <div class="form-group col-md-5">
                                            <select class="form-control" name="productId[]">
                                                <option>Sản phẩm cho mượn</option>
                                        ...
                                        <div class="form-group col-md-3">
                                            <input name="qty_loan[]"
                                                class="form-control @error('qty_loan') is-invalid @enderror" type="number"
                                                placeholder="Số lượng cho mượn" required>
                                            <span
                                                class="text-danger">{{ $errors->has('additional_body') ? $errors->first('body') : '' }}</span>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <input name="qty_returned[]"
                                                class="form-control @error('qty_returned') is-invalid @enderror"
                                                type="number" placeholder="Số lượng trả">
                                            <span
                                                class="text-danger">{{ $errors->has('additional_body') ? $errors->first('body') : '' }}</span>
                                        </div>
